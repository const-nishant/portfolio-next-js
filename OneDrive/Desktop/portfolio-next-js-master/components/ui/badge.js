...
const badgeVariants = cva(
  "inline-flex items-center rounded-[1vw] border border-transparent px-2.5 py-1.5 text-sm font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
